...
public class Tiger3ProcessorForComponent extends Tiger3ProcessorForPackaged {
  private static final String TAG = "Tiger3ProcessorForComponent";
...
//        "TigerDaggerGeneratorProcessor.process(). all dependencyInfos: %s", dependencyInfos));
    ...
    HubInjectorGenerator hubInjectorGenerator =
        new HubInjectorGenerator(
            eitherComponent,
            dependencies,
