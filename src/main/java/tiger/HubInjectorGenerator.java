...
class HubInjectorGenerator extends GeneralInjectorGeneratorHubClone {
  ...
  private String createStringProvidingKey(BindingKey key) {
    ...
    if (dependencyInfo != null && dependencyInfo
      ...
      builder.append(")");
        ...
        || utils.isPublicAndAncestor(utils.getClassFromKey(dependencyInfo.getDependant()))) {
  ...
  protected void generateGetPackagedInjectorMethod(String packageString) {
    ...
    generateFieldIfNeeded(packagedInjectorClassName, packagedInjectorSourceName);
    StringBuilder statementBuilder = new StringBuilder("$L = new $T(");
    ...
    injectorBuilder.addMethod(
        MethodSpec.methodBuilder(utils.getGetMethodName(packagedInjectorClassName))
            ...
            .beginControlFlow("if ($L == null)", packagedInjectorSourceName)
            .addStatement(
                statementBuilder.toString(), packagedInjectorSourceName, packagedInjectorClassName)
            .endControlFlow()
            .addStatement("return $L", packagedInjectorSourceName)
            .build());
  }
