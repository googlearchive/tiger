 ...
 */
abstract class GeneralInjectorGeneratorHubClone {
  ...
  protected final SetMultimap<BindingKey, DependencyInfo> dependencies;
  ...
  protected final Set<TypeElement> nonNullaryCtorModules;
  private String initializeMethodName;

  public GeneralInjectorGeneratorHubClone(
  ...
  protected final void generateFieldIfNeededCommon(
      TypeName typeName, String fieldName, boolean initialize) {
  ...
  protected final void generateProvisionMethodFromClass(BindingKey key, String suffix) {
    ...
    if (shouldInjectAfterCreation() && !utils.isNotSpecializedGeneric(cls.asType())
